...
$_SESSION['DayPlat']=$_POST['DayOfEvent'];




$_SESSION['CopsAndThievesDaily']='true';
$GoTo="editfordailyevents.php";
header(sprintf('Location: %s', $GoTo));
...
if (isset($_POST['GoBackToForm'])){
	$_SESSION['CopsAndThievesDaily']='false';
	unset($_SESSION['DayPlat']);	
...
/*AFTER POST DAY SUBMIT */


if (isset($_SESSION['DayPlat'])){




if (isset($_POST['DelBg'])){
$bgTarget = "Pic/Calendar/".$_SESSION['DayPlat']."/"."DaysGoneBg.png";
...
if (isset($_POST['Del1'])){
$slide1 = "Pic/Calendar/".$_SESSION['DayPlat']."/"."1SlideS1.png";
...
if (isset($_POST['Del2'])){
$slide2 = "Pic/Calendar/".$_SESSION['DayPlat']."/"."2SlideS1.png";
...
if (isset($_POST['Del3'])){
$slide3 = "Pic/Calendar/".$_SESSION['DayPlat']."/"."3SlideS1.png";
...
if (isset($_POST['Del4'])){
$slide4 = "Pic/Calendar/".$_SESSION['DayPlat']."/"."4SlideS1.png";
...
if (isset($_POST['Del5'])){
$slide5 = "Pic/Calendar/".$_SESSION['DayPlat']."/"."5SlideS1.png";
...
$h1path="Text/Events/".$DayPlat."/h1.txt";
if (file_exists($h1path) && $_POST['h1']!=="" ){
file_put_contents($h1path, $_POST['h1']);
;}else if($_POST['h1']!==""){
$Createh1=fopen("Text/Events/".$DayPlat."/h1.txt","a");
file_put_contents($h1path, $_POST['h1']);	
}else if($_POST['h1']==""){
...
$h2path="Text/Events/".$DayPlat."/h2.txt";
if (file_exists($h2path) && $_POST['h2']!=="" ){
file_put_contents($h2path, $_POST['h2']);
;}else if($_POST['h2']!==""){
$Createh2=fopen("Text/Events/".$DayPlat."/h2.txt","a");
file_put_contents($h2path, $_POST['h2']);	
}else if($_POST['h2']==""){
...
$h3path="Text/Events/".$DayPlat."/h3.txt";
if (file_exists($h3path) && $_POST['h3']!=="" ){
file_put_contents($h3path, $_POST['h3']);
;}else if($_POST['h3']!==""){
$Createh3=fopen("Text/Events/".$DayPlat."/h3.txt","a");
file_put_contents($h3path, $_POST['h3']);	
}else if($_POST['h3']==""){
...
$h4path="Text/Events/".$DayPlat."/h4.txt";
if (file_exists($h4path) && $_POST['h4']!=="" ){
file_put_contents($h4path, $_POST['h4']);
;}else if($_POST['h4']!==""){
$Createh4=fopen("Text/Events/".$DayPlat."/h4.txt","a");
file_put_contents($h4path, $_POST['h4']);	
}else if($_POST['h4']==""){
...
$h5path="Text/Events/".$DayPlat."/h5.txt";
if (file_exists($h5path) && $_POST['h5']!=="" ){
file_put_contents($h5path, $_POST['h5']);
;}else if($_POST['h5']!==""){
$Createh5=fopen("Text/Events/".$DayPlat."/h5.txt","a");
file_put_contents($h5path, $_POST['h5']);	
}else if($_POST['h5']==""){
    ...
    $target_dir = "Pic/Calendar/".$_SESSION['DayPlat']."/";
$target_file = $target_dir .($_FILES["1SlideS1"]["name"]);
    move_uploaded_file($_FILES["1SlideS1"]["tmp_name"], $target_file);
}
}else{
...
$target_file = $target_dir .($_FILES["2SlideS1"]["name"]);
    move_uploaded_file($_FILES["2SlideS1"]["tmp_name"], $target_file);
}
}else{
	echo "<script>alert('Put an image with less than 1Mb size')</script>";
}
...
$target_file = $target_dir .($_FILES["3SlideS1"]["name"]);
    move_uploaded_file($_FILES["3SlideS1"]["tmp_name"], $target_file);
}
}else{
	echo "<script>alert('Put an image with less than 1Mb size')</script>";
}
...
$target_file = $target_dir .($_FILES["4SlideS1"]["name"]);
    move_uploaded_file($_FILES["4SlideS1"]["tmp_name"], $target_file);
}
}else{
	echo "<script>alert('Put an image with less than 1Mb size')</script>";
}
...
$target_file = $target_dir .($_FILES["5SlideS1"]["name"]);
    move_uploaded_file($_FILES["5SlideS1"]["tmp_name"], $target_file);
}
}else{
	echo "<script>alert('Put an image with less than 1Mb size')</script>";
}
...
$target_file = $target_dir .($_FILES["DaysGoneBg"]["name"]);
    move_uploaded_file($_FILES["DaysGoneBg"]["tmp_name"], $target_file);
}
}else{
	echo "<script>alert('Put an image with less than 1Mb size')</script>";
}
...
$p1path="Text/Events/".$DayPlat."/p1.txt";
if (file_exists($p1path) && $_POST['p1']!=="" ){
file_put_contents($p1path, $_POST['p1']);
;}else if($_POST['p1']!==""){
$Createp1=fopen("Text/Events/".$DayPlat."/p1.txt","a");
file_put_contents($p1path, $_POST['p1']);	
}else if($_POST['p1']==""){
...
$p2path="Text/Events/".$DayPlat."/p2.txt";
if (file_exists($p2path) && $_POST['p2']!=="" ){
file_put_contents($p2path, $_POST['p2']);
;}else if($_POST['p2']!==""){
$Createp2=fopen("Text/Events/".$DayPlat."/p2.txt","a");
file_put_contents($p2path, $_POST['p2']);	
}else if($_POST['p2']==""){
...
$p3path="Text/Events/".$DayPlat."/p3.txt";
if (file_exists($p3path) && $_POST['p3']!=="" ){
file_put_contents($p3path, $_POST['p3']);
;}else if($_POST['p3']!==""){
$Createp3=fopen("Text/Events/".$DayPlat."/p3.txt","a");
file_put_contents($p3path, $_POST['p3']);	
}else if($_POST['p3']==""){
...
$p4path="Text/Events/".$DayPlat."/p4.txt";
if (file_exists($p4path) && $_POST['p4']!=="" ){
file_put_contents($p4path, $_POST['p4']);
;}else if($_POST['p4']!==""){
$Createp4=fopen("Text/Events/".$DayPlat."/p4.txt","a");
file_put_contents($p4path, $_POST['p4']);	
}else if($_POST['p4']==""){
...
$p5path="Text/Events/".$DayPlat."/p5.txt";
if (file_exists($p5path) && $_POST['p5']!=="" ){
file_put_contents($p5path, $_POST['p5']);
;}else if($_POST['p5']!==""){
$Createp5=fopen("Text/Events/".$DayPlat."/p5.txt","a");
file_put_contents($p5path, $_POST['p5']);	
}else if($_POST['p5']==""){
...
<div id="infoForForm">Choose a day  to set up an event that will be repeated non-stop each week.
The repeated events are getting replaced if there is a specific event set up for that day.</div>
<br>
...
<br><br>
<p style="color:orange;">Theres no Option to disable delete mode(no need since preview is on covering the space. If you just let it empty it will delete</p>
  <input type="submit" name="PlatSubmit" value="Post Day" style="margin-left:0.5em;font-size:3em;margin-top:0.1em">
</form>
</div>
...
<div id="ChosenDay"><?php if (isset($_SESSION['DayPlat'])){echo '(Daily set)Chosen day:';}?><br><span style="color:lightblue;">   <?php 
if (isset($_SESSION['DayPlat'])){
echo  $_SESSION['DayPlat'] ;
}?> 
</span></div>
<div id="currentDay">Current day:<br></div>

<?php if (isset($_SESSION['DayPlat'])){
...
<p style="font-size:1.5em;margin-top:3em;text-align:left;width:100%">Background of Events (refresh if you deleted but still visible [Control+R])</p>
<div class="ImgDiv" style="height:25em !important">
	<?php
	if (isset($_SESSION['DayPlat'])){
	echo "<img class='PrevNow' alt='Theres No Image' src='Pic/Calendar/".$_SESSION['DayPlat']."/DaysGoneBg.png'>";
...
<div class="ImgDiv" >
	<?php
	if (isset($_SESSION['DayPlat'])){
	echo "<img class='PrevNow'  alt='Theres No Image' src='Pic/Calendar/".$_SESSION['DayPlat']."/1SlideS1.png'>";
...
<div class="ImgDiv">
		<?php
	if (isset($_SESSION['DayPlat'])){
	echo "<img class='PrevNow' alt='Theres No Image' src='Pic/Calendar/".$_SESSION['DayPlat']."/2SlideS1.png'>";
...
<div class="ImgDiv">
		<?php
	if (isset($_SESSION['DayPlat'])){
	echo "<img class='PrevNow' alt='Theres No Image' src='Pic/Calendar/".$_SESSION['DayPlat']."/3SlideS1.png'>";
...
<div class="ImgDiv">
		<?php
	if (isset($_SESSION['DayPlat'])){
	echo "<img class='PrevNow' alt='Theres No Image' src='Pic/Calendar/".$_SESSION['DayPlat']."/4SlideS1.png'>";
...
<div class="ImgDiv">
		<?php
	if (isset($_SESSION['DayPlat'])){
	echo "<img class='PrevNow' alt='Theres No Image' src='Pic/Calendar/".$_SESSION['DayPlat']."/5SlideS1.png'>";
...
<?php 
if (isset($_SESSION['DayPlat'])){
	$trickyP="Text/Events/".$_SESSION['DayPlat']."/tricky.txt";
...
<?php
if (isset($_SESSION['CopsAndThievesDaily']) && $_SESSION['CopsAndThievesDaily']=='true' ){
...
if (isset($_SESSION['CopsAndThievesDaily']) && $_SESSION['CopsAndThievesDaily']=='false' ){
