...
PHP 7.2 / mysql(8.0.32) / uses jquery too

You need to create the mysqli tables and login in order to see the calendar and the Forum.
Import the mysql tables from the mysql folder(if you cant import them because of version conflict or anything
just recreate them with copy-paste commands.check mysql folder for details)
...
(Only events with specific duration have additional info and pictures. Perpetual weekly events don't have any extra info.Search a bit the
options as administrator)
